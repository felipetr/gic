  ...
  <div class="modal-dialog modal-dark " role="document">
    <div class="modal-content bg-dark">
      <div class="modal-header">
        <h5 class="modal-title" id="DeleteWorkareaModalLabel">Excluir Área de Atuação</h5>
	  ...
	  Tem certeza que deseja deletar a área de atuação <b class="d-inline-block nameofuser"></b>?
...
<div class="modal fade" id="EditWorkareaModal" tabindex="-1" role="dialog" aria-labelledby="EditWorkareaModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dark " role="document">
    <div class="modal-content bg-dark">
      <div class="modal-header">
        <h5 class="modal-title" id="EditWorkareaModalLabel">Editar Área de Atuação</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="modal fade" id="NewWorkareaModal" tabindex="-1" role="dialog" aria-labelledby="NewWorkareaModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dark " role="document">
    <div class="modal-content bg-dark">
      <div class="modal-header">
        <h5 class="modal-title" id="NewWorkareaModalLabel">Adicionar Área de Atuação</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
