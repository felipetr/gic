             ...
             <?php foreach ($query as $key => $result) { ?>
                 <li id="wa-<?php echo $result->id; ?>" data-name="<?php echo $result->name; ?>" data-id="<?php echo $result->id; ?>" class="btn alert-warning realul d-block  mb-2 text-left" data-slug='<?php echo $result->slug; ?>'>
                     ...
                     <span class="float-right pause">
                         <button type="button" data-id="<?php echo $result->id; ?>" class="btn btn-danger text-white trashbtn"><i class="fas fa-trash"></i></button>
                         <button type="button" data-id="<?php echo $result->id; ?>" class="btn btn-info text-light editbtn"><i class="fas fa-edit"></i></button>
                     </span>
                 </li>
             <?php } ?>
