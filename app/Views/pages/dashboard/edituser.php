        ...
        <div class="col-12 col-md-6 col-lg-9">
            <div class="form-row">
                <div class="col-12 col-xl-9">
                    ...
                    <input class="form-control mb-3" value="<?php echo $query->name; ?>" name="name" required>
                </div>
                <div class="col-12 col-xl-3 pb-3">
                    Gênero
                    <select name="gender" class="custom-select" required>
                        <option selected value="x">Prefiro não informar</option>
                        <option <?php if ($query->gender == 'a'){ echo 'selected'; } ?> value="a">Feminino</option>
                        <option <?php if ($query->gender == 'o'){ echo 'selected'; } ?> value="o">Masculino</option>
                    </select>
                </div>
                ...
                <div class="col-12 col-xl-<?php echo $col;
                    ...
                    <input type="text" name="cpf" class="form-control onlynumbers" value="<?php echo $query->cpf; ?>" <?php if ($col == 4) {
                                                                                                echo 'required';
                                                                                            } ?>>
                </div>
                <div class="col-12 col-xl-<?php echo $col;
                ...
                <div class="col-12 col-xl-<?php echo $col;
                    ...
                    <select name="workarea" class="custom-select" <?php if ($col == 6) {
                        ...
                        <?php foreach ($workarea as &$value) { ?>
                            <option <?php if ($query->workarea == $value->slug){ echo 'selected'; } ?> value="<?php echo $value->slug; ?>"><?php echo $value->name; ?></option>
                        <?php } ?>
                    </select>
                </div>
                ...
                <div class="col-12 col-xl-4 pb-3">
                    ...
                    <select name="state" class="custom-select" required>
                        <option value=""></option>
                        <option <?php if ($query->uf == 'AC'){ echo 'selected'; } ?> value="AC">Acre</option>
<option <?php if ($query->uf == 'AL'){ echo 'selected'; } ?> value="AL">Alagoas</option>
<option <?php if ($query->uf == 'AP'){ echo 'selected'; } ?> value="AP">Amapá</option>
<option <?php if ($query->uf == 'AM'){ echo 'selected'; } ?> value="AM">Amazonas</option>
<option <?php if ($query->uf == 'BA'){ echo 'selected'; } ?> value="BA">Bahia</option>
<option <?php if ($query->uf == 'CE'){ echo 'selected'; } ?> value="CE">Ceará</option>
<option <?php if ($query->uf == 'DF'){ echo 'selected'; } ?> value="DF">Distrito Federal</option>
<option <?php if ($query->uf == 'ES'){ echo 'selected'; } ?> value="ES">Espírito Santo</option>
<option <?php if ($query->uf == 'GO'){ echo 'selected'; } ?> value="GO">Goiás</option>
<option <?php if ($query->uf == 'MA'){ echo 'selected'; } ?> value="MA">Maranhão</option>
<option <?php if ($query->uf == 'MT'){ echo 'selected'; } ?> value="MT">Mato Grosso</option>
<option <?php if ($query->uf == 'MS'){ echo 'selected'; } ?> value="MS">Mato Grosso do Sul</option>
<option <?php if ($query->uf == 'MG'){ echo 'selected'; } ?> value="MG">Minas Gerais</option>
<option <?php if ($query->uf == 'PA'){ echo 'selected'; } ?> value="PA">Pará</option>
<option <?php if ($query->uf == 'PB'){ echo 'selected'; } ?> value="PB">Paraíba</option>
<option <?php if ($query->uf == 'PR'){ echo 'selected'; } ?> value="PR">Paraná</option>
<option <?php if ($query->uf == 'PE'){ echo 'selected'; } ?> value="PE">Pernambuco</option>
<option <?php if ($query->uf == 'PI'){ echo 'selected'; } ?> value="PI">Piauí</option>
<option <?php if ($query->uf == 'RJ'){ echo 'selected'; } ?> value="RJ">Rio de Janeiro</option>
<option <?php if ($query->uf == 'RN'){ echo 'selected'; } ?> value="RN">Rio Grande do Norte</option>
<option <?php if ($query->uf == 'RS'){ echo 'selected'; } ?> value="RS">Rio Grande do Sul</option>
<option <?php if ($query->uf == 'RO'){ echo 'selected'; } ?> value="RO">Rondônia</option>
<option <?php if ($query->uf == 'RR'){ echo 'selected'; } ?> value="RR">Roraima</option>
<option <?php if ($query->uf == 'SC'){ echo 'selected'; } ?> value="SC">Santa Catarina</option>
<option <?php if ($query->uf == 'SP'){ echo 'selected'; } ?> value="SP">São Paulo</option>
<option <?php if ($query->uf == 'SE'){ echo 'selected'; } ?> value="SE">Sergipe</option>
<option <?php if ($query->uf == 'TO'){ echo 'selected'; } ?> value="TO">Tocantins</option>
<option <?php if ($query->uf == 'EX'){ echo 'selected'; } ?> value="EX">Extrangeiro</option>
                    </select>
                </div>
                <div class="col-12 col-xl-4 pb-3">
            ...
            <div class="alert alert-secondary text-secondary">
				...
				<div >
                        ...
                        <div class="alert alert-light">
                            ...
                            <div class="form-row">
                                <div class="col-12 col-sm-4">
                                    <button data-avalia="1" type="button" class="btn btn<?php if($query->status != 1){echo '-outline'; }?>-danger btn-avalia btn-block">C</button>
                                </div>
                                <div class="col-12 col-sm-4">
                                    <button data-avalia="2" type="button" class="btn btn<?php if($query->status != 2){echo '-outline'; }?>-warning btn-avalia btn-block">B</button>
                                </div>
                                <div class="col-12 col-sm-4">
                                    <button data-avalia="3" type="button" class="btn btn<?php if($query->status != 3){echo '-outline'; }?>-success btn-avalia btn-block">A</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <select class="custom-select mb-3" name="tipoconta">
                        <option></option>
                        <option <?php if ($query->uf == 'CC'){ echo 'selected'; } ?> value="CC">Corrente</option>
                        <option <?php if ($query->uf == 'CP'){ echo 'selected'; } ?> value="CP">Poupança</option>
                        <option <?php if ($query->uf == 'CS'){ echo 'selected'; } ?> value="CS">Salário</option>
                        <option <?php if ($query->uf == 'CD'){ echo 'selected'; } ?> value="CD">Digital</option>
                        <option <?php if ($query->uf == 'CU'){ echo 'selected'; } ?> value="CU">Universitária</option>
                    </select>
